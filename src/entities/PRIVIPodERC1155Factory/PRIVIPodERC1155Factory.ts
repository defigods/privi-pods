...
export class PRIVIPodERC1155Factory extends SmartContract {
  static bind(address: Address): PRIVIPodERC1155Factory {
    return new PRIVIPodERC1155Factory("PRIVIPodERC1155Factory", address);
  }
  ...
  createPod(uri: string, podId: string): Address {
  ...
  try_createPod(uri: string, podId: string): CallResult<Address> {
