...
export class PRIVIPodERC721RoyaltyFactory extends SmartContract {
  static bind(address: Address): PRIVIPodERC721RoyaltyFactory {
    return new PRIVIPodERC721RoyaltyFactory(
